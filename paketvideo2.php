...
<body>
  ...
  ?>
    ...
    <div class="container-fluid bg-3 text-center">
      <h3>Platinum Video Package</h3><br>
      <img src="https://www.samhurdphotography.com/wp-content/uploads/2013/04/bride-and-groom-leica-m-review.jpg" class="img-responsive" style="width:100%" alt="Image">
      <div class="row">
        <h2>Platinum Video Package</h2>
        <h4>Include <br>
        ...
        <h4 style="color: red">Rp; 6.500.000.00</h4>


        <br>
        <a href="formbooking.php?id_paket=5">
