...
<body>
  ...
  ?>
    ...
    <div class="container-fluid bg-3 text-center">
      <h3>Paket Foto</h3><br>
      <img src="https://cdn-image.hipwee.com/wp-content/uploads/2019/03/hipwee-wedding-decor-ideas-singapore-joyce-melvin-750x422.jpg" class="img-responsive" style="width:100%" alt="Image">
      <div class="row">
        ...
        <h4>Include <br>
          ...
          80 Edit photo <br>
          Flashdisk 8 Gb <br>
          1 Link Google Drive 15 Gb
        </h4>
        <br><br>

        <h4 style="color: red">Rp; 4.000.000.00</h4>

        <br>
        <a href="formbooking.php?id_paket=2">
