...
<body>
  ...
  ?>
    ...
    <div class="container-fluid bg-3 text-center">
      <h3>Paket Foto</h3><br>
      <img src="https://luxurylifestyleawards.com/wp-content/uploads/2018/12/wedding-planner-services-bg.png" class="img-responsive" style="width:100%" alt="Image">
      <div class="row">
        <h2>Gold Package</h2>
        <h4>Include <br>
          ...
          80 Edit photo <br>
          Flashdisk 8 Gb <br>
          1 Link Google Drive 15 Gb <br>
          3 Cetak 20Rs and Frame
        </h4>
        <br><br>

        <h4 style="color: red">Rp; 6.000.000.00</h4>

        <br>
        <a href="formbooking.php?id_paket=3">
