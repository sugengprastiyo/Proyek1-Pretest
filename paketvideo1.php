...
<body>
  ...
  ?>
    ...
    <div class="container-fluid bg-3 text-center">
      <h3>Silver Video Package</h3><br>
      <img src="https://photographycourse-net.exactdn.com/wp-content/uploads/2018/09/wedding-photography-classes.jpg?strip=all&lossy=1&quality=70&fit=1024%2C683&ssl=1" class="img-responsive" style="width:100%" alt="Image">
      <div class="row">
        <h2>Silver Video Package</h2>
        <h4>Include <br>
          2 Videographer and 1 Director <br>
          1 Minutes Cinematic <br>
        </h4>
        <br><br>

        <h4 style="color: red">Rp; 2.500.000.00</h4>



        <br>
        <a href="formbooking.php?id_paket=4">
